  ...
  return (
      <main className='container mx-auto mt-5 md:mt-20 p-5 md:flex md:justify-center'>
         <div className='md:w-2/3 lg:w-2/5'>
            ...
            Alquiler de Barcos <br/> Panel de Administración 
            </h1>
            <br/><br/>
            <h1 className=" bg-gradient-to-r from-indigo-200 via-slate-700 to-indigo-200 bg-clip-text font-display text-3xl tracking-tight text-transparent text-center">
            Proyecto G10 Grupo 8  
            </h1>
            <form 
            ...
            >
              ...
              <div className=' flex flex-col space-y-4 '>
                ...
                <input 
                  ...
                  className="bg-slate-600 mb-5 w-full py-3 text-white uppercase font-bold rounded hover:cursor-pointer hover:bg-slate-800 transition-colors"
              />
            <Link 
            to={"/crear-cuenta"}
